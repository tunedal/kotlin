...
public class DiagnosticsTestWithStdLibUsingJavacGenerated extends AbstractDiagnosticsTestWithStdLibUsingJavac {
    ...
    public static class Inference extends AbstractDiagnosticsTestWithStdLibUsingJavac {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class PostponedArguments extends AbstractDiagnosticsTestWithStdLibUsingJavac {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
            }
            ...
            @TestMetadata("dontFixVariablesContainedInOutputType2.kt")
            public void testDontFixVariablesContainedInOutputType2() throws Exception {
            ...
            public void testElvis() throws Exception {
                runTest("compiler/testData/diagnostics/testsWithStdLib/inference/postponedArguments/elvis.kt");
            }
